...
2026-09-25状态更新：已收到两组完整外部LB CE各28点；对Current为−0.070549%/−0.017510%，
对R3增量为+0.023403%/+0.076633%。见[表格核验及R8依据](TS_Predictor_R7_Evidence_for_R8.md)。
下文的“未运行完整CTC”属于本地实现/重命名时的历史记录，不代表外部结果未到达。
