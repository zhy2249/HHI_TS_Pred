...
\newenvironment{OptionTableNoShorthandLongParameter}[2]{%
	\scriptsize
	\def\arraystretch{1.8}
	\clearOptions
	\begin{longtable}{l<{\makecell[tl]{\optOption}}%
	                  c<{\makecell[tc]{\optDefault}}%
	                  >{\def\arraystretch{1.0}}p{0.35\textwidth}<{\clearOptions}}
	\caption{#1} \label{#2} \\
	\hspace*{12em}&\hspace*{8em}&\kill
	\hline
	 \thead{Option} &
...
for the VVC project. It applies to version 20.0 of the software.
\end{abstract}
...
%\ShortOption{\None} &
\Default{true} &
Enables or disables the use of Decoder-side Intra Mode Derivation (DIMD).
\\

\Option{TIMD} &
%\ShortOption{\None} &
\Default{true} &
Enables or disables the use of Template-based Intra Mode Derivation (TIMD).
\\

\Option{TIMDSAD} &
%\ShortOption{\None} &
\Default{true} &
Enables or disables the use of extended Template-based Intra Mode Derivation (TIMD) with SAD cost metric.
\\

\Option{OBIC} &
%\ShortOption{\None} &
\Default{true} &
Enables or disables the use of Occurrence-based intra coding (OBIC).
\\

\Option{EIP} &
%\ShortOption{\None} &
\Default{true} &
Enables or disables the use of extrapolation filter-based intra prediction (EIP).
\\

\Option{MMEIP} &
%\ShortOption{\None} &
\Default{false} &
Enables or disables the use of multi-model extrapolation filter-based intra prediction (MMEIP).
\\
...
\begin{OptionTableNoShorthandLongParameter}{Neural network post-filter characteristics}{tab:sei-nn-post-filter-characteristics}
  ...
  \\
  \Option{SEINNPostFilterCharacteristicsPropertyPresentFlag\emph{i}} &
  \Default{false} &
  ...
  \par
  \begin{tabular}{cp{0.14\textwidth}}
  ...
  \end{tabular}
  \\
  \Option{SEINNPostFilterCharacteristicsInpFormatIdc\emph{i}} &
  \Default{0} &
  ...
  \par
    ...
    \end{tabular}
  \\
  \Option{SEINNPostFilterCharacteristicsInpTensorBitLumaDepthMinusEight\emph{i}} &
  \Default{0} &
  ...
  \\
  \Option{SEINNPostFilterCharacteristicsInpTensorBitDepthChromaMinusEight\emph{i}} &
  \Default{0} &
  ...
  \end{tabular}
  \\
  \Option{SEINNPostFilterCharacteristicsOutFormatIdc\emph{i}} &
  \Default{0} &
  ...
  \end{tabular}
  \\
  \Option{SEINNPostFilterCharacteristicsOutTensorBitDepthLumaMinusEight\emph{i}} &
  \Default{0} &
  ...
  \\
  \Option{SEINNPostFilterCharacteristicsOutTensorBitDepthChromaMinusEight\emph{i}} &
  \Default{0} &
  ...
  \\
  \Option{SEINNPostFilterCharacteristicsNumberInputDecodedPicsMinusOne\emph{i}} &
  \Default{0} &
  ...
  \\
  \Option{SEINNPostFilterCharacteristicsInputPicOutputFlag\emph{i}} &
  \Default{false} &
  ...
  \\
\end{OptionTableNoShorthandLongParameter}
...
\\
\Option{SEIPONumofPrefixByte\emph{i}} &
\Default{0} &
Specifies the number of prefix byte for the \emph{i}-th SEI message present in processing order SEI message.
\\
