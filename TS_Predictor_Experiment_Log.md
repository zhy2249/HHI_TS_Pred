...
最后更新：2026-09-24。这是本项目 TS predictor 研究的统一实验台账；
...
| TS-014 | **R7**：CG-entry CABAC fractional评分、old-R3 shadow、R2/R3评分替换 | 已实现，42项短测与6项自然序列shadow通过；新模式完整CTC未运行 | R7-1=原R2-2新评分，R7-2=原R3-1新评分；winner分歧29.32%，成本差MAE降低40.18%；条件CG率反而增加0.298707%/0.033802%，非BD-rate；算法增量Weak，不加R6-derived组 |
