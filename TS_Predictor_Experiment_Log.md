...
| TS-015 | **R8**：评分规则交叉、完整候选、小样本分布、路径和量化搜索 | 24组规格及收件目录已建立，数学参考检查通过；未实现codec或编码 | 首批1a：A01/A04/A08/B03/B05/B07；1b：A09/A10/A11/B01；保留其余14组分阶段配对，不预设收益；Current唯一anchor |
