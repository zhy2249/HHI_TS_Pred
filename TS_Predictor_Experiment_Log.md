...
最后更新：2026-09-25。这是本项目 TS predictor 研究的统一实验台账；
...
| TS-015 | **R8**：评分规则交叉、完整候选、小样本分布、路径和量化搜索 | 首批八组C++/宏/batch已实现，人工工程验证通过；96项真实短测与正式CTC未跑 | 首轮MODE 1/4/8/13/15/16/17/19；CE计划224点，其余16组暂缓；Current唯一anchor；见R8 Implementation/Validation |
