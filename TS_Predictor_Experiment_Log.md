...
| TS-015 | **R8**：评分规则交叉、完整候选、小样本分布、路径和量化搜索 | 24组目录保留；首轮按用户要求收敛为八组，详细规格与数学参考通过；未实现codec或编码 | 首轮MODE 1/4/8/13/15/16/17/19；B04补齐候选×稀疏对照并作为平滑父法；CE计划224点，其余16组暂缓；Current唯一anchor |
